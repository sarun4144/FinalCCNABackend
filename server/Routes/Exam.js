...
,Easyrecord,Hardrecord,CountStamp,removeExam,listexamSort,listexamSortDate} = require("../Controller/Exam");
const { auth,adminCheck } = require('../Middleware/Auth')

router.get("/listexam",listexam);
router.get("/listexamSort",listexamSort);
router.get("/listexamSortDate",listexamSortDate);
